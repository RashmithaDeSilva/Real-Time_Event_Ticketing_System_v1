...
import realtime_event_ticketing_system.cli.dao.SalesLogDAO;
...
public class SalesLogDAOImpl implements SalesLogDAO {
    private static SalesLogDAOImpl instance;
    ...
    public static SalesLogDAOImpl getInstance() {
        if (instance == null) {
            connection = SQLiteConnection.getInstance().getConnection();
            instance = new SalesLogDAOImpl();
        }
        return instance;
    }
    ...
    public List<SalesLog> getAllLogs() {
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                salesLog.add(new SalesLog(resultSet.getInt("id"),
